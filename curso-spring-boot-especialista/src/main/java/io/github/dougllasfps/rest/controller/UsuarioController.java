...
import io.github.dougllasfps.rest.dto.CredentiaisDTO;
...
public class UsuarioController {
    ...
    @PostMapping("/auth")
    public TokenDTO autenticar(@RequestBody CredentiaisDTO credentiais){
        try {
            Usuario usuario = Usuario.builder()
                    .login(credentiais.getLogin())
                    .senha(credentiais.getSenha())
                    .build();
